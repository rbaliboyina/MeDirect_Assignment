...
export default defineConfig({
  ...
  reporter: [
    ["html", { open: "always", outputFile: "playwright-html-report" }],
    ["json", { open: "never", outputFile: "playwright-report.json" }],
  ],
  ...
  use: {
    ...
    navigationTimeout: 45000, // Timeout for page navigation (45 seconds)
